...
<div class="content-wrapper">
  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Bảng danh sách danh mục</h4>
              ...
              <tr>
                ...
                <td class="text-center">
                  <label class="badge badge-{{ $category->status == 1 ? 'success' : 'danger' }}">
                    {{ $category->status == 1 ? 'Hoạt động' : 'Đang dừng' }}
                  </label>
                </td>
                <td class="text-center">
                  <button class="btn btn-primary btn-rounded btn-icon" data-url="{{ route('campaign-edit', ['id' => $category->id]) }}">
                    <i class="ti-pencil"></i>
                  </button>
                </td>
              </tr>
